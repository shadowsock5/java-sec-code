...
//        String result = com.feihong.ldap.utils.Util.base64Encode(bytes);
//
//        return result;
//    }
//
...
//        InputStream in = com.feihong.ldap.utils.Util.class.getProtectionDomain().getClassLoader().getResourceAsStream(resoucePath);
...
//            byte[] bytes = com.feihong.ldap.utils.Util.base64Decode(cmd);
